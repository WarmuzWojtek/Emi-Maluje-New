...
/*!**********************************!*\
  !*** ./src/components/header.js ***!
  \**********************************/
/*! exports provided: bigAnime */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"bigAnime\", function() { return bigAnime; });\nvar bigAnime = function bigAnime() {\n  var big = document.querySelector(\".header__imgBigContainer\");\n  var small = document.querySelector(\".header__imgSmallContainer\");\n  var tittle1 = document.querySelector(\".header__tittle1\");\n  var tittle2 = document.querySelector(\".header__tittle2\");\n  var headerBtn = document.querySelector(\".header__button\");\n  var navi = document.querySelector('.navi');\n  var naviItemCover = document.querySelectorAll('.navi__listElement-cover');\n  var burger = document.querySelector('.header__burger');\n  gsap.set(tittle1, {\n    x: \"-95vw\"\n  });\n  gsap.set(tittle2, {\n    opacity: 0\n  });\n  gsap.set(headerBtn, {\n    opacity: 0\n  });\n  gsap.to(big, {\n    x: '10vw',\n    duration: 30,\n    repeat: -1,\n    yoyo: true,\n    ease: 'none'\n  });\n  gsap.to(small, {\n    x: '-40vw',\n    duration: 30,\n    yoyo: true,\n    repeat: -1,\n    ease: 'none'\n  });\n  gsap.to(tittle1, {\n    x: '5vw',\n    duration: 2\n  });\n  gsap.to(tittle2, {\n    opacity: 1,\n    duration: 3,\n    delay: 2\n  });\n  gsap.to(headerBtn, {\n    opacity: 1,\n    duration: 3,\n    delay: 4\n  });\n  headerBtn.addEventListener('click', function () {\n    if (window.innerWidth < 1280) {\n      headerBtn.style.display = \"none\";\n      navi.style.transform = \"translateX(0)\";\n      gsap.to('.navi__listElement-cover', {\n        x: '-100%',\n        duration: 0.25,\n        ease: Power0,\n        stagger: 0.25\n      });\n      burger.innerHTML = '<i class=\"fas fa-times\"></i>';\n    } else {\n      headerBtn.style.display = \"none\";\n      gsap.fromTo('.navi__listElement', {\n        opacity: 0\n      }, {\n        opacity: 1,\n        duration: 1,\n        ease: Power0,\n        stagger: 0.5\n      });\n      navi.style.zIndex = 6;\n    }\n  });\n  burger.addEventListener('click', function () {\n    if (burger.innerHTML === '<i class=\"fas fa-bars\"></i>') {\n      headerBtn.style.display = \"none\";\n      navi.style.transform = \"translateX(0)\";\n      gsap.to('.navi__listElement-cover', {\n        x: '-100%',\n        duration: 0.25,\n        ease: Power0,\n        stagger: 0.25\n      });\n      burger.innerHTML = '<i class=\"fas fa-times\"></i>';\n    } else {\n      headerBtn.style.display = \"block\";\n      navi.style.transform = \"translateX(-100vw)\";\n      gsap.to('.navi__listElement-cover', {\n        x: 0,\n        duration: 0.1,\n        ease: Power0\n      });\n      burger.innerHTML = '<i class=\"fas fa-bars\"></i>';\n    }\n  });\n};\n\n//# sourceURL=webpack:///./src/components/header.js?");
...
/*!********************************!*\
  !*** ./src/components/navi.js ***!
  \********************************/
/*! exports provided: navi */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"navi\", function() { return navi; });\nvar navi = function navi() {\n  var burger = document.querySelector('.header__burger');\n  var links = document.querySelectorAll(\".navi__nav-link\");\n  links.forEach(function (link, index) {\n    link.addEventListener('click', function (e) {\n      e.preventDefault();\n      burger.innerHTML = '<i class=\"fas fa-bars\"></i>';\n      gsap.to(window, {\n        duration: 1,\n        scrollTo: {\n          y: \"#section\" + (index + 1)\n        }\n      });\n\n      if (window.innerWidth < 1280) {\n        gsap.to('.navi', {\n          x: \"-100vw\",\n          duration: 0.1\n        });\n        gsap.to('.navi__listElement-cover', {\n          x: 0,\n          duration: 0.1,\n          ease: Power0\n        });\n      }\n    });\n  });\n};\n\n//# sourceURL=webpack:///./src/components/navi.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _sass_index_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./sass/index.scss */ \"./src/sass/index.scss\");\n/* harmony import */ var _sass_index_scss__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_sass_index_scss__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _components_header_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/header.js */ \"./src/components/header.js\");\n/* harmony import */ var _components_about_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/about.js */ \"./src/components/about.js\");\n/* harmony import */ var _components_social_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/social.js */ \"./src/components/social.js\");\n/* harmony import */ var _components_gallery_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/gallery.js */ \"./src/components/gallery.js\");\n/* harmony import */ var _components_contact_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/contact.js */ \"./src/components/contact.js\");\n/* harmony import */ var _components_navi_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/navi.js */ \"./src/components/navi.js\");\n\n\n\n\n\n\n\ngsap.registerPlugin(ScrollTrigger);\ngsap.registerPlugin(ScrollToPlugin); // window.addEventListener('DOMContentLoaded', bigAnime);\n\nwindow.addEventListener('DOMContentLoaded', _components_about_js__WEBPACK_IMPORTED_MODULE_2__[\"about\"]); // window.addEventListener('DOMContentLoaded', social);\n// window.addEventListener('DOMContentLoaded', gallery);\n// window.addEventListener('DOMContentLoaded', contact);\n// window.addEventListener('DOMContentLoaded', navi);\n\nObject(_components_header_js__WEBPACK_IMPORTED_MODULE_1__[\"bigAnime\"])(); // about();\n\nObject(_components_social_js__WEBPACK_IMPORTED_MODULE_3__[\"social\"])();\nObject(_components_gallery_js__WEBPACK_IMPORTED_MODULE_4__[\"gallery\"])();\nObject(_components_contact_js__WEBPACK_IMPORTED_MODULE_5__[\"contact\"])();\nObject(_components_navi_js__WEBPACK_IMPORTED_MODULE_6__[\"navi\"])();\n\n//# sourceURL=webpack:///./src/index.js?");
